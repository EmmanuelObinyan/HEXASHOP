  ...
  return (
    <>
      ...
      >
        ...
        <p className="text-gray-700 capitalize font-bold my-4 sm:text-lg md:text-2xl lg:text-4xl ml-7">
          your cart
        </p>
        {cart.length > 0 ? (
          ...
          // for the empty cart
          <div className="xs:h-[25rem] sm:h-[35rem] w-[95%] bg-gray-100 flex flex-col items-center justify-center place-self-center mx-auto">
        ...
        {cart.length > 0 ? (
          ...
          <ul className="flex capitalize p-2  mt-6 sm:ml-7 md:ml-8.5 lg:ml-10">
            <Link to="/accessoriespage">
              <li className="font-semibold text-gray-800 mr-4 transition-all ease duration-150 xs:text-xs sm:text-sm md:text-md lg:text-lg active:text-orange-500 ">
