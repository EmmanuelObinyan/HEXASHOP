     ...
     <p className='font-bold md:text-lg lg:text-2xl p-3 capitalize text-gray-800 border-1 border-gray-300'>order summary</p>
        <div className='border-1  border-gray-300 p-3'>
          <span className='flex justify-between p-2 mt-5 '>
             ...
             <p className='font-semibold text-gray-600 xs:text-sm sm:text-sm md:text-md lg:text-xl '>{`${option === "NGN" ? "NGN" : "$"} ${option === "NGN" ? Math.round(currencyData * totalPrice):totalPrice} `}</p>
          </span>
          <span className='flex justify-between p-2 mt-3 '>
             ...
             <p className='font-semibold text-red-600 xs:text-sm sm:text-sm md:text-md lg:text-xl '>-{`${option === "NGN" ? "NGN" : "$"} ${option === "NGN" ? Math.round(currencyData * discountPrice):discountPrice.toFixed(2)}`}</p>
          </span>
           ...
           <span className='flex justify-between p-2 mt-5 '>
             ...
             <p className='font-semibold text-gray-800 xs:text-sm sm:text-sm md:text-md lg:text-2xl '>{`${option === "NGN" ? "NGN" : "$"} ${option === "NGN" ? Math.round(currencyData * discountPrice):discountPrice.toFixed(2)}`}</p>
          </span>
              <Button
                btnText={"checkout"}
