...
<div className=''>
     <form action=""className={` mx-auto mt-35 
      ...
      rounded-md w-[90%] ${dark ? "text-white shadow-lg":"text-gray-700 shadow-black"} sm:w-[50%] md:w-[55%]  lg:w-[38%] pt-5 pb-6`} >
        {/* for the ,message */}
        
          
          <h2 className='capitalize ml-3 text-[1rem] font-bold pb-2 md:text-[1.3rem] lg:text-[1.7rem]'>password reset</h2>
          <p className='ml-3  mb-2  md:mb-10  text-[0.8rem]  lg:mb-20   '>provide the email address associated with your account to recover your password</p>
          {/* for the label */}
        ...
        className={`block ml-3 transition-all ease duration-200 p-2 mt-2 focus:text-gray-700
        placeholder:${dark ? "text-white":"text-gray-700"} xs:text-[0.8rem] md:text-[0.9rem]  lg:text-[1.2rem] 
